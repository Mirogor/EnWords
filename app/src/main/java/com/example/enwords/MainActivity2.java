...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void onButtonClickCategory3(View view) {
        ...
        phrase.put("I will pay in cash. [aɪ wɪl peɪ ɪn kæʃ]", "Я заплачу наличными.");
        phrase.put("I will pay by card. [aɪ wɪl peɪ baɪ kɑːrd]", "Я заплачу картой.");
        phrase.put("What size do you need? [wʌt saɪz duː juː niːd]", "Какой размер Вам нужен?");
        phrase.put("Would you like to try it on? [wʊd juː laɪk tuː traɪ ɪt ɑːn]", "Вы хотели бы примерить это?");
        phrase.put("How about this one? [haʊ əˈbaʊt ðɪs wʌn]", "Как насчет этого?");
        phrase.put("Anything else? [ˈenɪθɪŋ els]", "Что-нибудь еще?");
        phrase.put("Wow, that is cheap! [waʊ ðæt ɪz tʃiːp]", "Вау! Это дешево!");
        phrase.put("That’s good value. [ðæt ɪz ɡʊd ˈvæljuː]", "Хорошая цена.");
        phrase.put("Oh, that’s expensive. [əʊ ðæt ɪz ɪkˈspensɪv]", "Оу, это дороговато.");
        phrase.put("Do you sell ...? [duː juː sel]", "Вы продаете ... ?");
        phrase.put("Are you in the queue? [ɑː juː ɪn ðə kjuː]", "Вы стоите в очереди?");
        phrase.put("Who’s next? [huː ɪz nekst]", "Кто следующий?");
        phrase.put("Will that be all? [wɪl ðæt biː ɔːl]", "Это все?");
        phrase.put("Have we met before? [hæv wiː met bɪˈfɔːr]", "Мы встречались с вами ранее?");
        phrase.put("What should I call you? [wʌt ʃʊd aɪ kɔːl juː]", "Как мне к вам обращаться?");
        phrase.put("It’s good to have you here! [ɪt ɪz ɡʊd tuː hæv juː hɪr]", "Приятно видеть вас здесь!");
        phrase.put("I’d like you to meet someone! [aɪ wʊd laɪk tuː miːt ˈsʌmwʌn]", " Я хочу вас кое с кем познакомить!");
        phrase.put("I’ve heard so much about you! [aɪ hæv səʊ mʌtʃ əˈbaʊt juː]", "Я столько о вас слышал!");
        phrase.put("I haven’t seen you for ages! [aɪ hæv nɒt siːn juː fɔːr ˈeɪdʒəz]", "Давно не виделись!");
        phrase.put("Good for you! [ɡʊd fɔːr juː]", "Рад за тебя!");
        phrase.put("Can’t argue with that [kæn nɒt ˈɑːrɡjuː wɪð ðæt]", "С этим не поспоришь");
        phrase.put("How do you know? [haʊ duː juː nəʊ]", "Откуда ты знаешь?");
        phrase.put("That’s a good question! [ðæt ɪz eɪ ɡʊd ˈkwestʃən]", "Хороший вопрос!");
        phrase.put("That would be great! [ðæt wʊd biː ɡreɪt]", "Было бы здорово!");
        phrase.put("No problem [nəʊ ˈprɑːbləm]", "Без проблем");
        phrase.put("Never mind, it’s fine! [ˈnevər maɪnd ɪt ɪz faɪn]", "Не стоит, все в порядке!");
        phrase.put("Anything new going on? [ˈenɪθɪŋ nuː ˈɡəʊɪŋ ɑːn]", "Что новенького?");
        phrase.put("You working the weekend? [juː ˈwɜːrkɪŋ ðə ˈwiːkend]", "Работаешь на выходных?");
        phrase.put("It’s so boring! [ɪt ɪz səʊ ˈbɔːrɪŋ]", "Скукотища!");
